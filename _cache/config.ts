...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Nicolai',
      'profile:last_name': 'Herforth',
      'og:url': 'https://nicolaiherforth.com',
      'og:description': 'Portfolio by Nicolai Herforth, Data Scientist',
      'og:author': 'Nicolai Herforth'
    },
     ...
     *  www.example.com
     */
    customDomain: 'nicolaiherforth.com',
  },
  ...
  data: {
    ...
    aboutMe: `
    I am a Data Sciencist graduated from the IT University of Copenhagen. Topics that interest me are:
    machine learning, natural language processing, topic modelling, text classification, image processing.
    <br><br>
    If you’d like to get in touch with me via email, click <a href="mailto:nicolaiherforth@gmail.com">here</a>.
    `,
    technologies: [
      'Python',
      'SQL',
